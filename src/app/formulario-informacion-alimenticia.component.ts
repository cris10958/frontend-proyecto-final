  ...
  template: `
    ...
    >
      <div class="col-md-6 ps-2">
        <label id="id-label-intolerancia" for="id-intolerancia-usuario" class="form-label"
      ...
      <div class="col-md-6">
        ...
        />
        <div class="invalid-feedback">Por favor ingrese a que alimentos es alérgico o intolerante</div>
      </div>
      <div class="col-md-6 ps-2">
        ...
        <div class="row-col-12">
          <div class="form-check form-check-inline">
            <input
              ...
              value="1"
            />
            <label class="form-check-label" for="inlineRadioinlineVeganoSi">Si</label>
          </div>
          <div class="form-check form-check-inline">
            <input
              ...
              value="0"
            />
            <label class="form-check-label" for="inlineRadioinlineVeganoNo">No</label>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <label for="id-peso-usuario" class="form-label">¿Cuál es tu objetivo de peso?</label>
        <input
          type="number"
          class="form-control fd-color white"
          id="id-peso-usuario"
          ...
          [class]="{
            'is-invalid':
              (informacion_alimenticia.get('peso')?.invalid || informacion_alimenticia.value.peso == '0') &&
              (informacion_alimenticia.get('peso')?.dirty || informacion_alimenticia.get('peso')?.touched)
          }"
          required
        />
        ...
        <div class="col-md-6 text-start ps-4">
          <button
            ...
            [disabled]="
              ...
              (alergia == '1' &&  informacion_alimenticia.value.detalle_alergia?.trim() == '') ||
              vegano == ''
            "
          >
            Actualizar
