...
import { SocioRegistro, SociosService } from './socios.service';
...
export class RegistroSocioComponent {
  ...
  registro(){
    if(this.socio.valid && this.emailValid){
      ...
      this.socioService.addSocio(socioRegistro)
      .subscribe(resp => {
  ...
  constructor(readonly listaDocumentoService: ListasService, private socioService: SociosService, private router: Router){}
}
